...
class ModelRaqdpsLayer(BaseLayer):
    """RAQDPS layer"""
    ...
    def __init__(self, provider_def):
        ...
        :returns: `geomet_data_registry.layer.model_raqdps.ModelRaqdpsLayer`  # noqa
        """

        provider_def = {'name': 'model_raqdps'}
    ...
    def __repr__(self):
        return '<ModelRaqdpsLayer> {}'.format(self.name)
