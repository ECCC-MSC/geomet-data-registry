...
class ModelRaqdpsFwCeLayer(BaseLayer):
    """RAQDPS-FW Cumulative Effects layer"""
    ...
    def __init__(self, provider_def):
        ...
        :returns: `geomet_data_registry.layer.model_raqdps-fw-ce.ModelRaqdpsFwCeLayer`  # noqa
        """

        provider_def = {'name': 'model_raqdps-fw-ce'}
    ...
    def __repr__(self):
        return '<ModelRaqdpsFwCeLayer> {}'.format(self.name)
